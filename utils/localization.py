...
TRANSLATIONS: Dict[str, Dict[str, Dict[str, str]]] = {
    ...
    "trim_operation": {
        ...
        "uz": {
            "start_time": "✂️ Qirqish boshlanish vaqtini kiriting (soniyalarda yoki MM:SS formatida):",
            "end_time": "✂️ Qirqish tugash vaqtini kiriting (soniyalarda, MM:SS formatida yoki variantlardan tanlang):",
            "invalid_time_format": "❌ Noto'g'ri vaqt formati. Iltimos, vaqtni soniyalarda yoki MM:SS formatida kiriting:",
            "positive_time": "❌ Boshlanish vaqti musbat son bo'lishi kerak. Iltimos, qaytadan urinib ko'ring:",
            "end_greater_than_start": "❌ Tugash vaqti boshlanish vaqtidan ({start_time}) katta bo'lishi kerak. Iltimos, qaytadan urinib ko'ring:",
            "end_of_video": "Video oxirigacha",
            ...
            "error_occurred": "❌ Xatolik yuz berdi: {error}. Iltimos, qaytadan urinib ko'ring.",
